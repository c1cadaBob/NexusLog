...
INSERT INTO roles (id, tenant_id, name, description, permissions) VALUES
    ...
    ('00000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000001', 'operator', '运维人员', '["logs:read", "logs:search", "alerts:read", "alerts:manage", "dashboard:read", "audit:read"]'),
