...
## 列出 E2E 用例（系统 Chrome）
e2e-list-chrome:
	@echo "📋 列出 E2E 用例（Chrome）..."
	@$(MAKE) e2e-list E2E_PLAYWRIGHT_CONFIG=playwright.chrome.config.js E2E_BASE_URL="$(E2E_BASE_URL)" E2E_TENANT_AUTO_SYNC="$(E2E_TENANT_AUTO_SYNC)"
