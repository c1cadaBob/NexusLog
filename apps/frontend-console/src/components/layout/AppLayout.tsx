...
const AppLayout: React.FC = () => {
  ...
  const useHeaderHelpLayout = ['/analysis/', '/alerts/', '/incidents/', '/security/', '/settings/', '/integration/', '/cost/', '/storage/', '/performance/', '/tracing/', '/reports/'].some((prefix) => location.pathname.startsWith(prefix));
