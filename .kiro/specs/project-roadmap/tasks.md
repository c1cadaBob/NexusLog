...
- [ ] 1. Monorepo 骨架和前端迁移（详见 frontend-migration spec）
  - [ ] 1.1 创建 Monorepo 根目录结构和根配置文件
...
- [ ] 10. 消息传输和流计算配置
  - [ ] 10.1 配置 Kafka 和 Schema Registry
